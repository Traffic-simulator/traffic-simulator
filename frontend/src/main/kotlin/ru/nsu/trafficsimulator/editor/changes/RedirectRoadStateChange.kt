...
class RedirectRoadStateChange(private val road: Road, private val newStartDir: Vec3, private val newEndDir: Vec3) : IStateChange {
    private val prevStartDir = road.startIntersection!!.position.toVec3() + road.getDirection(0.0)
    private val prevEndDir = road.endIntersection!!.position.toVec3() + road.getDirection(road.length)
