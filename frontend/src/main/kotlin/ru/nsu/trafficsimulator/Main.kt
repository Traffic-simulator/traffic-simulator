...
//        Editor.layout = Deserializer.deserialize(dto)
    ...
    fun initializeSimulation(layout: Layout) {
        ...
        spawnDetails.add(Waypoint("119", "1", Direction.BACKWARD))
        spawnDetails.add(Waypoint("114", "1", Direction.BACKWARD))
        spawnDetails.add(Waypoint("124", "1", Direction.BACKWARD))
        spawnDetails.add(Waypoint("107", "1", Direction.BACKWARD))
        spawnDetails.add(Waypoint("129", "1", Direction.BACKWARD))

        despawnDetails.add(Waypoint("119", "-1", Direction.FORWARD))
        despawnDetails.add(Waypoint("114", "-1", Direction.FORWARD))
        despawnDetails.add(Waypoint("124", "-1", Direction.FORWARD))
        despawnDetails.add(Waypoint("107", "-1", Direction.FORWARD))
        despawnDetails.add(Waypoint("129", "-1", Direction.FORWARD))
